...
import { View, ScrollView, TouchableOpacity,TouchableHighlight, Text, Image, Modal, StyleSheet } from 'react-native';
...
const App: React.FC = () => {
  ...
  return (
    <View>
      ...
      >
        <Text style={[styles.buttonText, selectedButton === 'activities' && styles.selectedButtonText]}>Activities</Text>
      </TouchableHighlight>

      <TouchableHighlight
        style={[styles.button, selectedButton === 'cuisines' && styles.selectedButton]}
        underlayColor="#DDDDDD"
        onPress={() => setSelectedButton('cuisines')}
      >
        <Text style={[styles.buttonText, selectedButton === 'cuisines' && styles.selectedButtonText]}>Cuisines</Text>
      </TouchableHighlight>

      <TouchableHighlight
        style={[styles.button, selectedButton === 'trekking' && styles.selectedButton]}
        underlayColor="#DDDDDD"
        onPress={() => setSelectedButton('trekking')}
      >
        <Text style={[styles.buttonText, selectedButton === 'trekking' && styles.selectedButtonText]}>Trekking</Text>
      </TouchableHighlight>
    </View>
